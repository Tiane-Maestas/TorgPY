...
def main():
    ...
    close_button = Button(title_bar, text='  ×  ', command=root.destroy,bg=RGRAY,padx=2,pady=2,font=("arial", 13),bd=0,fg=OFFWHITE,highlightthickness=0)
    expand_button = Button(title_bar, text=' 🗖 ', command=maximize_me,bg=RGRAY,padx=2,pady=2,bd=0,fg=OFFWHITE,font=("arial", 13),highlightthickness=0)
    minimize_button = Button(title_bar, text=' − ',command=minimize_me,bg=RGRAY,padx=2,pady=2,bd=0,fg=OFFWHITE,font=("arial", 13),highlightthickness=0)
    title_bar_title = Label(title_bar, text=tk_title, bg=RGRAY,bd=0,fg=OFFWHITE,font=("arial", 13, 'bold'),highlightthickness=0)
